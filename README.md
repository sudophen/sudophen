...
$${\color{lightgreen}Family \space Guy, \space Rick \space and \space Morty, \space Skins \space (UK), \space Shameless \space (US), \space Peep \space show, \space TUA !  }$$
...
$${\color{green}comfort \space characters}$$
   ...
   $${\color{lightgreen} Dipper \space Pines, \space Kyle \space Broflovski, \space Brian \space Griffin, \space Haru \space Akinashi, \space Kel, \space Mark \space Corrigan}$$
