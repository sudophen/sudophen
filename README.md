...
$${\color{green}fandoms \space (shows)}$$
 $${\color{lightgreen}Titans(2013), \space TTG, \space TT(2006), \space DCAMU, \space Southpark, \space IT, \space The \space Boys, \space invincible, \space Twilight, \space Eddsworld, \space Twilight, \space Invader ZIM, \space Rick \space and \space Morty,}$$
$${\color{lightgreen}Family \space Guy, \space Skins \space (UK), \space Shameless \space (US), \space TUA !  }$$
...
$${\color{green}comfort \space characters}$$
   $${\color{lightgreen}Edward \space Nygma, \space Damian \space Wayne, \space Respawn, \space Sid \space Jenkins, \space Phillip \space Gallagher, \space Evan \space Hansen, Five \space Hargreeves, \space Daniel \space Matthews, \space Dipper \space Pines, \space Kyle \space Broflovski}$$
